...
class Timeline {
  public:
     ...
     * we will look for active events from the beginning. The resulting time will be less than the given time.
     *
    ...
    /**
     * @brief Return the first event that will become active (starting from the given time). If an event is active at
